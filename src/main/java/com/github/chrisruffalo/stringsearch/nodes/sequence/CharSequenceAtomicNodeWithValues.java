...
import com.github.chrisruffalo.stringsearch.nodes.NodeWithValuesAndAtomicChildren;

public class CharSequenceAtomicNodeWithValues<T> extends NodeWithValuesAndAtomicChildren<T> {
